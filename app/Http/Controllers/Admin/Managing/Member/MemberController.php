...
namespace App\Http\Controllers\Admin\Managing\Member;
...
class MemberController extends ManagingController
{
    ...
    public function index(Request $request, $property_id){
        ...
        try {
            ...
            ${$member->plural()} = $member->showAll((new Temp())->getCompanyDefault()->getKey(), [], !Utility::isExportExcel());
        ...
        if(Utility::isExportExcel()){
            $view = SmartView::excel(null, compact($this->singular(), $member->singular(), $member->plural()), Translator::transSmart('app.Members', 'Members'));
        }else{
    ...
    public function add(Request $request, $property_id){
        ...
        ${$this->singular()} = $this->getModel()->getOneOrFail($property_id);
        ${$member->singular()}->status = Utility::constant('status.1.name');
        ${$member->singular()}->timezone = Config::get('app.timezone', 'UTC');
        ...
        return SmartView::render(null, compact($this->singular(), $member->singular(), $sandbox->singular(), 'properties'));
    ...
    public function postAdd(Request $request, $property_id){
        ...
        return redirect()->route('admin::managing::member::index', array('property_id' => $property_id))->with(Sess::getKey('success'), Translator::transSmart('app.Member has been added.', 'Member has been added.'));
    ...
    public function postEdit(Request $request, $property_id, $id){
        ...
        return $this->responseIntended('admin::managing::member::index', array('property_id' => $property_id))->with(Sess::getKey('success'), Translator::transSmart('app.Member has been updated.', 'Member has been updated.'));
    ...
    public function postEditNetwork(Request $request, $property_id,  $id){
        ...
        return $this->responseIntended('admin::managing::member::index', array('property_id' => $property_id))->with(Sess::getKey('success'), Translator::transSmart('app.Network configuration has been updated.', 'Network configuration has been updated.'));
    }
    ...
    public function postEditPrinter(Request $request, $property_id, $id){
        ...
        return $this->responseIntended('admin::managing::member::index', array('property_id' => $property_id))->with(Sess::getKey('success'), Translator::transSmart('app.Printer configuration has been updated.', 'Printer configuration has been updated.'));
    ...
    public function postDelete(Request $request, $property_id, $id){
        ...
        return $this->responseIntended('admin::managing::member::index', array('property_id' => $property_id))->with(Sess::getKey('success'), Translator::transSmart('app.Member has been deleted.', 'Member has been deleted.'));
    ...
    public function postTopUpWallet(Request $request, $property_id, $id){
        ...
        return redirect()
            ->to(URL::getAdvancedLandingIntended('admin::managing::member::wallet', [$property_id, $id],  URL::route('admin::managing::member::wallet', array('property_id' => $property_id, 'id' => $id))))
    ...
    public function postEditWalletTransaction(Request $request, $property_id, $user_id,  $id){
        ...
        return redirect()
            ->to(URL::getAdvancedLandingIntended('admin::managing::member::wallet', [$property_id, $user_id],  URL::route('admin::managing::member::wallet', array('property_id' => $property_id, 'id' => $user_id))))
    ...
    public function subscriptionFacility(Request $request, $property_id, $facility_id, $facility_unit_id){

        $member = new Member();
        $list = $member->listForSubscribing($request->get('query'), $property_id, false);
    ...
    public function subscriptionPackage(Request $request, $property_id, $package_id){

        $member = new Member();
        $list = $member->listForSubscribing($request->get('query'), $property_id, true);
    ...
    public function reservation(Request $request, $property_id, $facility_id){

        $member = new Member();
        $list = $member->listForReservation($request->get('query'), $property_id, $facility_id);
        //$list = new Collection() ;
