...
namespace App\Libraries\FulltextSearch;
...
class Search
{
    ...
    const SEARCH_MINIMUM_WORD_LENGTH 			= 1;
	...
	private $userQueryStringDeepCleaned;

    public function __construct($userQueryString, $caseInsensitive=true, $userQueryStringCleaned=true, $userQueryStringDeepCleaned = true)
    {
        $this->wordStemmerObj = new WordStemmer();
        ...
        $this->userQueryStringDeepCleaned = $userQueryStringDeepCleaned;
    ...
    public function GetSearchQueryArray()
    {
        ...
        if($this->userQueryStringDeepCleaned){
	        $this->userQueryString = self::DeepCleanUserQueryString($this->userQueryString);
        }
	...
	protected static function DeepCleanUserQueryString($userQueryString)
	{
		$userQueryString =  preg_replace('/[^a-zA-Z0-9-_\.]/',' ', $userQueryString);
		
		return $userQueryString;
	}

    protected static function BuildSearchQuery(WordStemmer $wordStemmerObj, $wordsArray, $keywordsArray = array())
    {
