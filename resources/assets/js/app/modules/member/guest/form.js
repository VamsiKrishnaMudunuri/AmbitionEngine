$(function () {
    ...
    $('.add-guest').click(function(e){
        ...
        if (i<6){
            $('.guest-list').append('<tr valign="top"><td><input type="text" class="form-control field-name" id="name" name="guest_list[]" value="" placeholder="Name" /> &nbsp;</td><td><input type="text" class="form-control field-email" id="email" name="guest_list[]" value="" placeholder="Email" /> &nbsp;</td><td><button type="button" class="btn btn-theme btn-block remove-guest">Remove</button> &nbsp;</td></tr>');
            i++;
