$(function() {
    ...
    var $addMemberForm = $('.add-member-form');
    var $member = $addMemberForm.find('.users');
    var $memberHidden = $addMemberForm.find('.users_hidden');
    var $addMember = $addMemberForm.find('.add-member');
    var $submit = $addMemberForm.find('.submit');
