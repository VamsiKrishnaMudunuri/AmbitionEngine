...
@section('content')
    ...
    <div class="admin-managing-lead-book-subscription-package">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                @include('templates.admin.managing.subscription.book_form', array( 'route' =>  array('admin::managing::lead::post-book-subscription-package', $property->getKey(), $lead->getKey(), $package->getKey(), Crypt::encrypt($start_date)), 'is_facility' => false, 'is_ajax_submit' => true, 'is_from_lead' => true))
