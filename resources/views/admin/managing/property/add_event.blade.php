...
@section('title', Translator::transSmart('app.Add Event', 'Add Event'))
...
@section('breadcrumb')
    ...
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['admin::managing::property::add-event', Translator::transSmart('app.Add Event', 'Add Event'), ['property_id' => $property->getKey()], ['title' => Translator::transSmart('app.Add Event', 'Add Event')]],
        ))
...
@section('content')
    ...
    <div class="admin-managing-property-add-event">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                'route' => array('admin::managing::property::post-add-event', $property->getKey()),
                'post' => $post,
                'property' => $property,
                'going' => $going,
                'place' => $place,
