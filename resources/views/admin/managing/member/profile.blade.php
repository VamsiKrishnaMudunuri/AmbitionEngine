...
@section('styles')
    @parent
    {{ Html::skin('app/modules/admin/managing/member/profile.css') }}
@endsection
    ...
    {{
        ...
        Html::breadcrumb(array(
            ...
            [URL::getAdvancedLandingIntended('admin::managing::member::index', [$property->getKey()],  URL::route('admin::managing::member::index', array('property_id' => $property->getKey()))),  Translator::transSmart('app.Members', 'Members'), [], ['title' =>  Translator::transSmart('app.Members', 'Members')]],
             ...
             ['admin::managing::member::profile', Translator::transSmart('app.Profile', 'Profile'), ['property_id' => $property->getKey(), 'id' => $member->getKey()], ['title' =>  Translator::transSmart('app.Profile', 'Profile')]]
...
@section('content')
    ...
    <div class="admin-managing-member-profile">
            ...
            <div class="col-sm-12">
                ...
                <?php
                    ...
                    $profile = [
                        ...
                        Translator::transSmart('app.Passport No.', 'Passport No.') => 'passport_number',
