...
@include('templates.admin.managing.gallery.item', array(
    ...
    'acls' => [Utility::rights('write.slug') => $isWrite, Utility::rights('delete.slug') => $isDelete],
     'actions' => [
        Utility::rights('write.slug') => URL::route("admin::managing::gallery::edit-cover", array('property_id' => $property->getKey(), 'id' => $sandbox->getKey())),
       Utility::rights('delete.slug') => URL::route("admin::managing::gallery::post-delete-cover", array('property_id' => $property->getKey(), 'id' => $sandbox->getKey())),
    ]
))