...
@section('breadcrumb')
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['admin::managing::subscription::book-package', Translator::transSmart('app.Booking', 'Booking'), ['property_id' => $property->getKey(), 'package_id' => $package->getKey(), 'start_date' => Hashids::encode($start_date)], ['title' =>  Translator::transSmart('app.Booking', 'Booking')]]
...
@section('content')
    ...
    <div class="admin-managing-subscription-booking-package">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                @include('templates.admin.managing.subscription.book_form', array( 'route' =>  array('admin::managing::subscription::post-book-package', $property->getKey(), $package->getKey(), Crypt::encrypt($start_date)), 'is_facility' => false))
