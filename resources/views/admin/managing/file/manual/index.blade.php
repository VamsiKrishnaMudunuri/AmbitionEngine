...
@section('title', Translator::transSmart('app.Manuals', 'Manuals'))
...
@section('content')
    ...
    <div class="admin-managing-file-manual-index">
        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    {{ Form::open(array('route' => array('admin::managing::file::manual::index', $property->getKey()), 'class' => 'form-search')) }}
                    ...
                    <div class="toolbox">
                        <div class="tools">
                            @if($isWrite)
                                {{
                                    Html::linkRouteWithIcon(
                                      'admin::managing::file::manual::add',
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-toolbox">
                                            ...
                                            @if($isWrite)
                                                ...
                                                {{
                                                   Html::linkRouteWithIcon(
                                                     'admin::managing::file::manual::edit',
                                            ...
                                            @endif
                                            @if($isDelete)
                                                {{ Form::open(array('route' => array('admin::managing::file::manual::post-delete', $property->getKey(), $sandbox->getKey()), 'class' => 'text-inline', 'onsubmit' => 'return confirm("' . Translator::transSmart('app.Are you sure to delete?', 'Are you sure to delete?') . '");'))}}
                                                {{ method_field('DELETE') }}
