...
@section('title', Translator::transSmart('app.Commissions Structure', 'Commissions Structure'))

@section('scripts')
    @parent
    {{ Html::skin('app/modules/admin/commission/index.js') }}
@endsection

@section('content')

    <div class="admin-commission-country-index">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="page-header">
                    <h3>{{Translator::transSmart('app.Managing commission by countries', 'Managing commission by countries')}}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                {{ Form::open(array('route' => array('admin::commission::index'), 'class' => 'form-search')) }}
                            ...
                            <tr>
                                ...
                                <td>
                                    @can(Utility::rights('write.slug'), [$admin_module_policy, $admin_module_model, $admin_module_slug, $admin_module_module])
                                        {{Form::checkbox('status', Utility::constant('status.1.slug'), $country['is_active'], array('class'=> 'toggle-checkbox', 'data-url' => URL::route('admin::commission::post-country', array('country' => $country['code'])) , 'data-toggle' => 'toggle', 'data-onstyle' => 'theme', 'data-on' => Utility::constant('status.1.name'), 'data-off' => Utility::constant('status.0.name') ) )}}
                                    @else
