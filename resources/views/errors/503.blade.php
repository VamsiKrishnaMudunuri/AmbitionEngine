...
@section('title', Translator::transSmart('app.Service Unavailable - 503', 'Service Unavailable - 503'))
@section('content')
    ...
    <div class="error-page">
        ...
        <p class="description">
            {{Translator::transSmart('exception.service_unavailable', 'The server is temporarily unable to service your request due to maintenance downtime.Please try again later.')}}
        </p>
        <p class="link">
