<div class="braintree-payment horizontal">
    ...
    <div class="braintree-payment-new-card-form {{$newCardFormClass}}">
        <div class="form-group {{isset($no_show_required_symbol) ? '' : 'required'}}">
            <label for="credit-card-number" class="col-sm-2 control-label">
        ...
        <div class="form-group {{isset($no_show_required_symbol) ? '' : 'required'}}">
            <label for="credit-card-expiry" class="col-sm-2 control-label">{{Translator::transSmart('app.Card Expiry Date', 'Card Expiry Date')}}</label>
        ...
        <div class="form-group {{isset($no_show_required_symbol) ? '' : 'required'}}">
            ...
            @endphp
            <label for="credit-card-cvc" class="col-sm-2 control-label">
