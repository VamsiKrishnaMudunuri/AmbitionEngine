            ...
            <div class="menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    @if($isWrite)
                        ...
                        <li>
                            {{Html::linkRoute(null, Translator::transSmart('app.Edit', 'Edit'), array(), array('class' => 'edit-event', 'data-inline-loading' => sprintf('menu-%s', $post->getKey()), 'data-url' => URL::route('member::post::post-edit-event', array($post->getKeyName() => $post->getKey()))))}}
                        </li>
                        <li>
