<nav class="navbar navbar-inverse navbar-fixed-top root">
    <div class="container">
                        ...
                        <li class="dropdown">
                            ...
                            @if( $hasMultiplePortals )
                                <a href="javascript:void(0);" class="portal dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <span class="name">{{Translator::transSmart('app.Root', 'Root')}}</span>
                        ...
                        <li class="dropdown">
                            ...
                            <a href="javascript:void(0);" class="profile dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <div class="photo">
                                    ...
                                    ?>
                                    {{ \App\Models\Sandbox::s3()->link($root_module_auth_user->profileSandboxWithQuery, $root_module_auth_user, $config, $dimension,  array())}}

                                </div>
                                <div class="name">
                                    {{$root_module_auth_user->full_name}}
                                </div>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu account-menu">
                                ...
                                <li>
                                    {{Html::linkRoute(Domain::route('member::profile::index'), Translator::transSmart("app.Your Profile", "Your Profile"), ['username' => $root_module_auth_user->username], ['title' => Translator::transSmart("app.Your Profile", "Your Profile")])}}
                                </li>
                                <li role="separator" class="divider"></li>

                                <li>
                                    {{Html::linkRoute(Domain::route('member::company::index'), Translator::transSmart("app.Your Company", "Your Company"), ['slug' => ($root_module_auth_user->companyProfilePageWithQuery->exists && $root_module_auth_user->companyProfilePageWithQuery->metaWithQuery->exists ) ?  $root_module_auth_user->companyProfilePageWithQuery->metaWithQuery->slug : '' ], ['class' => 'owner_company_link', 'title' => Translator::transSmart("app.Your Company", "Your Company")])}}
                                </li>
                                ...
                                <li role="separator" class="divider"></li>
                                <li>
                                    {{Html::linkRouteWithIcon(Domain::route("auth::logout"), Translator::transSmart("app.Logout", "Logout"), '', array(), ['title'=> Translator::transSmart("app.Logout", "Logout")])}}
                                </li>
                                <li role="separator" class="divider"></li>
                                <li class="footer">
