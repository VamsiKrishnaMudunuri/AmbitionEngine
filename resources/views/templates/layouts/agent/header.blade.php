<nav class="navbar navbar-inverse navbar-fixed-top agent">
    <div class="container">
                            ...
                            <li class="dropdown">
                                ...
                                @if( $hasMultiplePortals )
                                    <a href="javascript:void(0);" class="portal dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <span class="name">{{Translator::transSmart('app.Agent', 'Agent')}}</span>
                            ...
                            <li class="dropdown">
                                ...
                                <a href="javascript:void(0);" class="profile dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <div class="photo">
                                        ...
                                        ?>
                                        {{ \App\Models\Sandbox::s3()->link($agent_module_auth_user->profileSandboxWithQuery, $agent_module_auth_user, $config, $dimension,  array())}}

                                    </div>
                                    <div class="name">
                                        {{$agent_module_auth_user->full_name}}
                                    </div>
                                    <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu account-menu">
                                    ...
                                    {{--
                                    <li>
                                        {{Html::linkRoute(Domain::route('member::profile::index'), Translator::transSmart("app.Your Profile", "Your Profile"), ['username' => $agent_module_auth_user->username], ['title' => Translator::transSmart("app.Your Profile", "Your Profile")])}}
                                    </li>
                                    ...
                                    {{--
                                    <li>
                                        {{Html::linkRoute(Domain::route('member::company::index'), Translator::transSmart("app.Your Company", "Your Company"), ['slug' => ($agent_module_auth_user->companyProfilePageWithQuery->exists && $agent_module_auth_user->companyProfilePageWithQuery->metaWithQuery->exists ) ?  $agent_module_auth_user->companyProfilePageWithQuery->metaWithQuery->slug : '' ], ['class' => 'owner_company_link',  'title' => Translator::transSmart("app.Your Company", "Your Company")])}}
                                    </li>
