                ...
                <div class="btn-group">
                    @php
                        $attributes = array(
                            ...
                            'onclick' =>  'location.href="' . URL::getAdvancedLandingIntended('admin::managing::property::guest', [$property->getKey()],  URL::route('admin::managing::property::guest', array('property_id' => $property->getKey()))) . '"; return false;'
