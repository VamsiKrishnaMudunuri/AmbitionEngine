        ...
        <tr>
            <td style="{{ $fontFamily }} {{ $style['email-body-cell'] }}">
                ...
                <p style="{{ $style['paragraph'] }}">
                    ...
                    Translator::transSmart('app.Your friend <b>%s</b> have invited you to drop a site visit on <b>%s %s</b>.',
                        sprintf('Your friend <b>%s</b> have invited you to drop a site visit on <b>%s %s</b>.',
                          $agent->full_name,
                          $date,
                          $time,
                          $timezone
                        ...
                        true,
                        ['name' => $agent->full_name, 'date' =>  $date, 'time' => $time, 'timezone' => $timezone]
                    )
                ...
                <p style="{{ $style['paragraph'] }}">
                    @if($booking->property->isActive() && !$booking->property->coming_soon)
