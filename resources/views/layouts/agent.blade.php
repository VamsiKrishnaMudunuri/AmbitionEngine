...
<html lang="{{App::getLocale()}}">
    ...
    <head>
        ...
        @section('styles')
            ...
            {{Html::skin('app/layouts/agent.css')}}
        @show

    </head>

    <body class="app agent layout-agent">
        ...
        <div class="nav-main">
            ...
            <header role="navigation">
                ...
                @else
                    @include('templates.layouts.' . 'agent' .'.header')
                @endif
            </header>
        ...
        @else
            @include('templates.layouts.' . 'agent' .'.nav_left_sidebar')
        @endif
        ...
        @section('scripts')
            ...
            {{Html::skin('app/modules/agent/agent.js')}}
        @show
