...
@section('title', Translator::transSmart('app.Packages - Fixed Desk', 'Packages - Fixed Desk'))
...
@section('top_banner_image_url', URL::skin('cms/packages/fixed_desk_top_banner.jpg'))
...
@section('content')
    <div class="page-packages page-packages-fixed-desk fixed-desk m-t-5-full">
        <div class="row">
            <div class="col-md-6">
                <div class="header-section">
                    ...
                    <ul class="monthly-item m-t-5-minus-full">
                        <li>24/7 access in your preferred fixed desk location</li>
                        <li>Business address and mail handling</li>
                        <li>Complimentary 5 hours of access to meeting rooms (additional hours at discounted rates)</li>
                        <li>120 pages of black & white printing or 30 pages of colour printing</li>
                        ...
                        <div class="package-box">
                            <div class="box">
                                ...
                                <div class="description">
                                    {{Translator::transSmart("app.Get your own desk and lockable drawers in a coworking space", "Get your own desk and lockable drawers in a coworking space")}}
                                </div>
                                <hr/>
                                ...
                                <div>
                                    {{ Translator::transSmart('app.Small startups and teams can benefit from a collaborative open working environment with a little more privacy. Reserved desks, chairs, trash cans, and lockable cabinets are accessible 24/7', 'Small startups and teams can benefit from a collaborative open working environment with a little more privacy. Reserved desks, chairs, trash cans, and lockable cabinets are accessible 24/7') }}
                                </div>
                                <br/>
...
{{--<div class="page-packages page-packages-fixed-desk fixed-desk">--}}
        ...
        {{--<div class="package-container">--}}
            {{--<div class="package-box col-xs-12 col-sm-6 col-md-5 col-lg-4">--}}
                {{--<div class="box">--}}
                    ...
                    {{--</div>--}}
                    {{--<div class="description">--}}
                        {{--{{Translator::transSmart("app.A dedicated desk for yourself in a shared workspace.", "A dedicated desk for yourself in a shared workspace.")}}--}}
                    {{--</div>--}}
                    {{--<hr />--}}
                    {{--<div class="price">--}}
            ...
            {{--<div class="row">--}}
                ...
                {{--<div class="col-xs-12 col-sm-5 col-md-6 col-lg-6 first">--}}
                    ...
                    {{--</div>--}}
                    {{--<p>--}}
                        {{--{{Translator::transSmart("app.Fixed Desks are designed for those who enjoy an open working environment with a little more privacy. 24/7 access to your own workspace. Collaborate with other members in the privacy of the Fixed Desk area.", "Fixed Desks are designed for those who enjoy an open working environment with a little more privacy. 24/7 access to your own workspace. Collaborate with other members in the privacy of the Fixed Desk area.")}}--}}
                    {{--</p>--}}

                    {{--<br />--}}

                    {{--<p>--}}
                        {{--{{Translator::transSmart("app.Fixed Desk subscribers enjoy their own reserved desk, chair, trash can and lockable cabinet. Members are also given 5 hours of access to the meeting rooms every month.", "Fixed Desk subscribers enjoy their own reserved desk, chair, trash can and lockable cabinet. Members are also given 5 hours of access to the meeting rooms every month.")}}--}}
                    {{--</p>--}}
                    ...
                    {{--<div class="features">--}}
                        {{--<table class="table">--}}
                            {{--<tr>--}}
                                ...
                                {{--</td>--}}
                                {{--<td>--}}
                                    {{--{{Translator::transSmart("app.24/7 accessibility to the fixed desk zone of a preferred location of your choice.", "24/7 accessibility to the fixed desk zone of a preferred location of your choice.")}}--}}
                                {{--</td>--}}
                            {{--</tr>--}}
                            {{--<tr>--}}
                                {{--<td>--}}
                                ...
                                {{--</td>--}}
                                {{--<td>--}}
                                    {{--{{Translator::transSmart("app.Complimentary 5 hours of access to the meeting rooms a month with discounted rates for additional hours.", "Complimentary 5 hours of access to the meeting rooms a month with discounted rates for additional hours.")}}--}}
                                {{--</td>--}}
                            {{--</tr>--}}
                            {{--<tr>--}}
                                {{--<td>--}}
                                ...
                                {{--</td>--}}
                                {{--<td>--}}
                                    {{--{{Translator::transSmart("app.120 pages of black & white or 30 pages of colour printing a month.", "120 pages of black & white or 30 pages of colour printing a month.")}}--}}
                                {{--</td>--}}
                            {{--</tr>--}}
                        {{--</table>--}}
                    {{--</div>--}}
            ...
            {{--<div class="row">--}}
                ...
                {{--<div class="col-xs-12 col-sm-5 col-md-6 col-lg-6">--}}
                    ...
                    {{--<h4>--}}
                        {{--<b>--}}
                            {{--{{Translator::transSmart("app.WHAT’S THE DIFFERENCE BETWEEN A FIXED DESK AND PRIVATE OFFICE?", "WHAT’S THE DIFFERENCE BETWEEN A FIXED DESK AND PRIVATE OFFICE?")}}--}}
                        {{--</b>--}}
                    {{--</h4>--}}
                    ...
                    {{--<p>--}}
                        {{--{{Translator::transSmart("app.A Fixed Desk is a reserved desk within the Fixed Desk zone, which is an open space with many desks dedicated to Fixed Desk subscribers.", "A Fixed Desk is a reserved desk within the Fixed Desk zone, which is an open space with many desks dedicated to Fixed Desk subscribers.")}}--}}
                    {{--</p>--}}
        ...
        {{--<div class="sign-up">--}}
            {{--<div class="image-frame">--}}
                ...
                {{--<div class="button">--}}
                    ...
                    {{--{{Html::linkRoute(null, Translator::transSmart("app.SIGN UP SITE VISIT", "SIGN UP SITE VISIT"), [], ['class' => 'btn btn-theme input-submit page-booking-trigger', 'data-page-booking-action' => 1, 'data-url' => URL::route('page::booking', []),'data-page-booking-package' =>  Utility::constant('package.fixed-desk.slug'), 'title' => Translator::transSmart("app.SIGN UP SITE VISIT", "SIGN UP SITE VISIT")])}}--}}
...
{{--@section('bottom_banner_image_url', URL::skin('packages/fixed-desk/office.jpg'))--}}

{{--@section('bottom_banner')--}}
    {{--<div class="page-packages page-packages-fixed-desk fixed-desk bottom-banner">--}}
