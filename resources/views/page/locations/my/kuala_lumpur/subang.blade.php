...
@section('title', Translator::transSmart('app.Subang', 'Subang'))
...
@section('breadcrumb')
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['page::index', Translator::transSmart('app.Subang', 'Subang'), ['slug' => 'locations/malaysia/kuala-lumpur/Subang'], ['title' => Translator::transSmart('app.Subang', 'Subang')]]
        ))
...
@section('top_banner_image_url', URL::skin('locations/malaysia/kuala-lumpur/subang.jpg'))
