...
@section('title', Translator::transSmart("app.Bukit Bintang", "Bukit Bintang"))
...
@section('breadcrumb')
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['page::index', Translator::transSmart("app.Bukit Bintang", "Bukit Bintang"), ['slug' => 'locations/malaysia/kuala-lumpur/bukit-bintang'], ['title' => Translator::transSmart("app.Bukit Bintang", "Bukit Bintang")]]
        ))
...
@section('top_banner_image_url', URL::skin('locations/malaysia/kuala-lumpur/bukit-bintang.jpg'))
        ...
        <div class="office-container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5 col-md-6 col-lg-6 first coming-soon">
                    ...
                    <p>
                        {{Translator::transSmart("app.This location will be opening in December. Give us your info and get the latest updates.", "This location will be opening in December. Give us your info and get the latest updates.")}}
                    </p>
