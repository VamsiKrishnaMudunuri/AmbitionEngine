...
@section('title', Translator::transSmart("app.WISMA MON'T KIARA", "WISMA MON'T KIARA"))
@section('page-footer-address', 'Unit Level 13A Wisma Mont’ Kiara, No 1 Jalan Kiara, Mont’ Kiara, 50480 Kuala Lumpur.')
...
@section('breadcrumb')
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['page::index', Translator::transSmart("app.Wisma Mont' Kiara", "Wisma Mont' Kiara"), ['slug' => 'locations/malaysia/kuala-lumpur/wisma-mont-kiara'], ['title' => Translator::transSmart("app.Wisma Mont' Kiara", "Wisma Mont' Kiara")]]
        ))
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                {{Html::skin('locations/malaysia/kuala-lumpur/wisma-mont-kiara/lounge1.jpg')}}
            </div>

            <div class="item">
                {{Html::skin('locations/malaysia/kuala-lumpur/wisma-mont-kiara/lounge2.jpg')}}
            </div>
            <div class="item">
                {{Html::skin('locations/malaysia/kuala-lumpur/wisma-mont-kiara/lounge3.jpg')}}
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="office-container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5 col-md-6 col-lg-6 first">
                    ...
                    <p>
                        {{Translator::transSmart("app.Mont Kiara is an affluent township located in the northwest of Kuala Lumpur. Common Ground Mont’ Kiara is situated at Wisma Mont’ Kiara, a 20-storey Grade A office tower which forms part of an integrated development that includes 1 Mont’ Kiara, a 6-storey mall.", "Mont Kiara is an affluent township located in the northwest of Kuala Lumpur. Common Ground Mont’ Kiara is situated at Wisma Mont’ Kiara, a 20-storey Grade A office tower which forms part of an integrated development that includes 1 Mont’ Kiara, a 6-storey mall.")}}
                    </p>

                    <br />

                    <p>
                        {{Translator::transSmart("app.Wisma Mont’ Kiara is strategically located between the central business districts of Kuala Lumpur and Damansara and is accessible via the Sprint, NKVE, Penchala Link, Kerinchi Link and Jalan Duta.", "Wisma Mont’ Kiara is strategically located between the central business districts of Kuala Lumpur and Damansara and is accessible via the Sprint, NKVE, Penchala Link, Kerinchi Link and Jalan Duta.")}}
                    </p>

                    <br />

                    <p>
                        {{Translator::transSmart("app.Common Ground at Wisma Mont’ Kiara accommodates 34 Private offices, 52 Fixed desks and 80 Hot desks. Featured in the venue are 2 large boardrooms, two discussion rooms, an in-house café and an event space for up 60 people.", "Common Ground at Wisma Mont’ Kiara accommodates 34 Private offices, 52 Fixed desks and 80 Hot desks. Featured in the venue are 2 large boardrooms, two discussion rooms, an in-house café and an event space for up 60 people.")}}
                    </p>
                    ...
                    <h5>
                         <b>{{Translator::transSmart("app.WISMA MONT' KIARA", "WISMA MONT' KIARA")}}</b>
                    </h5>
                    <div class="address">
                        <h6>
                            <span>
                            ...
                            <span>
                                Unit Level 13A Wisma Mont’ Kiara, No 1 Jalan Kiara, Mont’ Kiara, 50480 Kuala Lumpur.
                            </span>
                        </h6>
                    </div>
                    <br /><br />
                    <div class="map-container">
                        <div>
                            @php
                                $map = Mapper::map(3.165237, 101.652690, ['zoom' => 12,
                                'cluster' => false,
                                'center' => true,
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td class="person">
                                    ...
                                    <div class="photo">
                                        {{Html::skin('people/tina.png', array('class' => 'img-responsive img-circle'))}}
                                    </div>

                                </td>
                                <td>

                                    <b>{{Translator::transSmart("app.TINA LEE", "TINA LEE")}}</b>
                                    <p>
                                        {{Translator::transSmart("app.WISMA MONT' KIARA", "WISMA MONT' KIARA")}}
                                    </p>
                                    <br />
