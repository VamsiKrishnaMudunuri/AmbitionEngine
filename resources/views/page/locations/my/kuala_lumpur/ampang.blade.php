...
@section('title', Translator::transSmart('app.Ampang', 'Ampang'))
...
@section('breadcrumb')
    {{
        ...
        Html::breadcrumb(array(
            ...
            ['page::index', Translator::transSmart('app.Ampang', 'Ampang'), ['slug' => 'locations/malaysia/kuala-lumpur/ampang'], ['title' => Translator::transSmart('app.Ampang', 'Ampang')]]
        ))
...
@section('top_banner_image_url', URL::skin('locations/malaysia/kuala-lumpur/ampang.jpg'))
