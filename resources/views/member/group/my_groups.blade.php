...
@section('title', Translator::transSmart('app.Your Groups', 'Your Groups'))
...
@section('scripts')@parent
    ...
    {{ Html::skin('app/modules/member/group/my-groups.js') }}
@endsection
...
@section('content')
    ...
    <div class="member-group-my-groups">
        ...
        <div class="row">
            ...
            <div class="col-sm-7 col-md-8 col-sm-pull-5 col-md-pull-4">
                <div class="row">
                    <div class="col-sm-12">
                        {{ Form::open(array('route' => array('member::group::my-groups'), 'class' => 'form-search form-inline')) }}
                ...
                @endphp
                <div class="group-container infinite" data-paging="{{$group->getPaging()}}" data-url="{{URL::route('member::group::my-group',  $route_parameters)}}"  data-empty-text="{{Translator::transSmart('app.You not join any group yet', 'You not join any group yet')}}" data-ending-text="{{--Translator::transSmart('app.No More', 'No More')--}}">
